...
_HAS_CLICKHOUSE_CONNECT = importlib.util.find_spec("clickhouse_connect") is not None
...
if apps.is_installed("cvat.apps.events") and _HAS_CLICKHOUSE_CONNECT:
...
if apps.is_installed("cvat.apps.custom_operations"):
    urlpatterns.append(path("", include("cvat.apps.custom_operations.urls")))
