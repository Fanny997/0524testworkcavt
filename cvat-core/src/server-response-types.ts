...
export type CustomOperationKind = 'model' | 'augmentation';
export type CustomOperationFieldType =
    'string' | 'text' | 'integer' | 'number' | 'boolean' | 'select' | 'json' | 'file' | 'file_collection';

export interface SerializedCustomOperationFieldOption {
    label: string;
    value: any;
    description?: string;
}

export interface SerializedCustomOperationField {
    name: string;
    label?: string;
    type: CustomOperationFieldType;
    required?: boolean;
    description?: string;
    placeholder?: string;
    default?: any;
    options?: SerializedCustomOperationFieldOption[];
    accept?: string[];
    min_count?: number;
    max_count?: number;
    minimum?: number;
...
export interface SerializedCustomOperation {
    id: number;
    artifact_key: string;
    name: string;
    ...
    input_schema: SerializedCustomOperationField[];
    output_schema: any;
...
export interface APICustomOperationsFilter extends APICommonFilterParams {
    kind?: CustomOperationKind;
    is_active?: boolean;
}
export type CustomOperationsFilter = CamelizedV2<APICustomOperationsFilter>;
