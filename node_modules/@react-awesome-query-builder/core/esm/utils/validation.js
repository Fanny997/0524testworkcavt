...
export var getNewValueForFieldOp = function getNewValueForFieldOp(config) {
  ...
  var currentOperatorCardinality = currentOperator ? getOpCardinality(currentOperatorConfig) : null;
  var operatorCardinality = newOperator ? getOpCardinality(newOperatorConfig) : null;
  ...
  // build new values
  var newValue = new Immutable.List(Array.from({
    length: operatorCardinality
  }, function (_ignore, i) {
    return valueFixes[i] !== undefined ? valueFixes[i] : canReuseValue ? currentValue.get(i) : undefined;
  }));
  var newValueSrc = new Immutable.List(Array.from({
    length: operatorCardinality
  }, function (_ignore, i) {
  ...
  var newValueType = new Immutable.List(Array.from({
    length: operatorCardinality
  }, function (_ignore, i) {
  ...
  var newValueError = new Immutable.List(valueErrors);
  return {
