...
var fixPathsInTree = exports.fixPathsInTree = function fixPathsInTree(tree) {
  ...
  function _processNode(item, path, lev, nodeId) {
    ...
    var itemId = currId || nodeId || (0, _uuid["default"])();
...
var getFlatTree = exports.getFlatTree = function getFlatTree(tree) {
  ...
  function _flatizeTree(item, path, insideCollapsed, insideLocked, insideRuleGroup, lev, caseId, childNo) {
    ...
    if (!isRoot) {
      ...
      position.indexPath = [].concat((0, _toConsumableArray2["default"])(path.slice(1).map(function (id) {
...
var _fixImmutableValue = exports._fixImmutableValue = function _fixImmutableValue(v) {
