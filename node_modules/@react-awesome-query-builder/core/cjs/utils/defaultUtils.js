...
exports.getDefaultSubField = exports.getDefaultOperator = exports.getDefaultFieldSrc = exports.getDefaultField = exports.emptyProperties = exports.defaultRuleProperties = exports.defaultRule = exports.defaultRoot = exports.defaultOperatorOptions = exports.defaultItemProperties = exports.defaultGroupProperties = exports.defaultGroupConjunction = exports.defaultConjunction = exports.createListFromArray = void 0;
...
var defaultRuleProperties = exports.defaultRuleProperties = function defaultRuleProperties(config) {
  ...
  if (field && operator) {
    var canFix = false;
    var _getNewValueForFieldO = (0, _validation.getNewValueForFieldOp)(config, config, current, field, operator, "operator", canFix),
