...
var setValue = function setValue(state, path, delta, value, valueType, config, asyncListValues) {
  ...
  var lastRangeError = state.getIn((0, _treeUtils.expandTreePath)(path, "properties", "valueError", operatorCardinality));
