...
var settings = _objectSpread(_objectSpread({}, _ui.BasicConfig.settings), {}, {
  ...
  // localization
  locale: _objectSpread({}, _ui.BasicConfig.settings.locale),
...
var widgets = _objectSpread(_objectSpread({}, _ui.BasicConfig.widgets), {}, {
  ...
  treeselect: _objectSpread(_objectSpread({}, _ui.BasicConfig.widgets.treeselect), {}, {
  ...
  treemultiselect: _objectSpread(_objectSpread({}, _ui.BasicConfig.widgets.treemultiselect), {}, {
...
var ctx = _objectSpread(_objectSpread({}, _ui.BasicConfig.ctx), {}, {
  utils: _objectSpread(_objectSpread({}, _ui.BasicConfig.ctx.utils), {}, {
    normalizeListValues: _stuff.normalizeListValues
  }),
...
config = _ui.Utils.ConfigMixins.addMixins(config, ["rangeslider", "treeselect", "treemultiselect", "rangeable__date"]);
