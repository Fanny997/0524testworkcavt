...
var _Utils$ListUtils = _ui.Utils.ListUtils,
  getTitleInListValues = _Utils$ListUtils.getTitleInListValues,
  mapListValues = _Utils$ListUtils.mapListValues;
var TreeSelectWidget = exports["default"] = /*#__PURE__*/function (_Component) {
  ...
  (0, _inherits2["default"])(TreeSelectWidget, _Component);
  return (0, _createClass2["default"])(TreeSelectWidget, [{
    ...
    value: function render() {
      ...
      var width = aValue || !placeholderWidth ? null : placeholderWidth + _domUtils.SELECT_WIDTH_OFFSET_RIGHT + 6;
...
TreeSelectWidget.propTypes = {
  ...
  // obsolete
  treeValues: _propTypes["default"].oneOfType([_propTypes["default"].object, _propTypes["default"].array])
};