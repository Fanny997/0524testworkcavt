...
var Operator = exports["default"] = /*#__PURE__*/function (_Component) {
  ...
  return (0, _createClass2["default"])(Operator, [{
    ...
    value: function getMeta(_ref) {
      ...
      var operators = (0, _toConsumableArray2["default"])((fieldConfig === null || fieldConfig === void 0 ? void 0 : fieldConfig.operators) || ((_config$types$selecte = config.types[selectedFieldType]) === null || _config$types$selecte === void 0 ? void 0 : _config$types$selecte.operators) || []);
      ...
      var operatorsOptions = (0, _mapValues["default"])((0, _pickBy["default"])(config.operators, function (item, key) {
