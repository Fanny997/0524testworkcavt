...
var getFuncConfig = _core.Utils.ConfigUtils.getFuncConfig;
var _Utils$FuncUtils = _core.Utils.FuncUtils,
...
var FuncWidget = exports["default"] = /*#__PURE__*/function (_Component) {
...
FuncWidget.propTypes = {
  ...
  valueError: _propTypes["default"].string
};
var ArgWidget = /*#__PURE__*/function (_Component2) {
  function ArgWidget(props) {
    ...
    (0, _reactUtils.useOnPropsChanged)(_this2);
    _this2.onPropsChanged(props);
    return _this2;
  }
  (0, _inherits2["default"])(ArgWidget, _Component2);
  return (0, _createClass2["default"])(ArgWidget, [{
    ...
    value: function getMeta(_ref10) {
      ...
      var newParentFuncs = [].concat((0, _toConsumableArray2["default"])(parentFuncs || []), [[funcKey, argKey]]);
      return {
