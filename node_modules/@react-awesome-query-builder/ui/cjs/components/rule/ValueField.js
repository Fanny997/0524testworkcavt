...
var ValueField = exports["default"] = /*#__PURE__*/function (_Component) {
  ...
  return (0, _createClass2["default"])(ValueField, [{
    ...
    value: function buildOptions(parentFieldPath, config, fields) {
      ...
      return (0, _keys["default"])(fields).map(function (fieldKey) {
        var fullFieldPath = [].concat((0, _toConsumableArray2["default"])(path !== null && path !== void 0 ? path : []), [fieldKey]);
    ...
    value: function getFieldLabel(fieldOpts, fieldKey, config) {
      ...
      var label = (fieldOpts === null || fieldOpts === void 0 ? void 0 : fieldOpts.label) || (0, _last["default"])(fieldParts);
