...
var isEmptyRuleProperties = _core.Utils.RuleUtils.isEmptyRuleProperties;
  ...
  return (0, _createClass2["default"])(Rule, [{
    ...
    value: function renderField() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_FieldWrapper["default"], {
        key: "field",
        classname: (0, _classnames["default"])(selectedFieldSrc == "func" ? "rule--field--func" : "rule--field"),
        config: config,
        ...
        fieldError: fieldError,
        setField: !immutableFieldsMode ? setField : _utils.dummyFn,
        setFuncValue: !immutableFieldsMode ? setFuncValue : _utils.dummyFn,
        setFieldSrc: !immutableFieldsMode ? setFieldSrc : _utils.dummyFn,
        parentField: parentField,
    ...
    value: function renderWidget() {
      ...
      var widget = /*#__PURE__*/_react["default"].createElement(_Widget["default"], (0, _extends2["default"])({
        key: "values"
        ...
        setFuncValue: !immutableValuesMode ? this.props.setFuncValue : _utils.dummyFn,
    ...
    value: function renderError() {
      ...
      var oneError = [fieldError].concat((0, _toConsumableArray2["default"])((valueError === null || valueError === void 0 ? void 0 : valueError.toArray()) || [])).filter(function (e) {
        return !!e;
      }).shift() || null;
    ...
    value: function renderDrag() {
      ...
      return showDragIcon && /*#__PURE__*/_react["default"].createElement("div", {
        key: "rule-drag-icon",
    ...
    value: function render() {
      ...
      var body = /*#__PURE__*/_react["default"].createElement("div", {
        key: "rule-body",
        className: (0, _classnames["default"])("rule--body", canShrinkValue && "can--shrink--value")
      }, parts);
...
Rule.propTypes = {
  ...
  selectedFieldType: _propTypes["default"].string,
  ...
  valueType: _propTypes["default"].any,
  ...
  fieldError: _propTypes["default"].string,
  ...
  totalRulesCnt: _propTypes["default"].number,
  parentReordableNodesCnt: _propTypes["default"].number
};
var _default = exports["default"] = (0, _RuleContainer["default"])((0, _Draggable["default"])("rule")((0, _utils.WithConfirmFn)(Rule)));