...
import {
    ...
    SerializedCustomOperation, CustomOperationsFilter,
...
export default interface CVATCore {
    ...
    customOperations: {
        list: (filter?: CustomOperationsFilter) => Promise<SerializedCustomOperation[]>;
        get: (id: number) => Promise<SerializedCustomOperation>;
        create: (data: Record<string, any>) => Promise<SerializedCustomOperation>;
        update: (id: number, data: Record<string, any>) => Promise<SerializedCustomOperation>;
        delete: (id: number) => Promise<void>;
        execute: (id: number, data: Record<string, any>) => Promise<any>;
    };
    server: {
