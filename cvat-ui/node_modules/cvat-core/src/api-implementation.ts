...
export default function implementAPI(cvat: CVATCore): CVATCore {
    ...
    implementationMixin(
        cvat.customOperations.list,
        serverProxy.customOperations.list.bind(serverProxy.customOperations),
    );
    implementationMixin(
        cvat.customOperations.get,
        serverProxy.customOperations.get.bind(serverProxy.customOperations),
    );
    implementationMixin(
        cvat.customOperations.create,
        serverProxy.customOperations.create.bind(serverProxy.customOperations),
    );
    implementationMixin(
        cvat.customOperations.update,
        serverProxy.customOperations.update.bind(serverProxy.customOperations),
    );
    implementationMixin(
        cvat.customOperations.delete,
        serverProxy.customOperations.delete.bind(serverProxy.customOperations),
    );
    implementationMixin(
        cvat.customOperations.execute,
        serverProxy.customOperations.execute.bind(serverProxy.customOperations),
    );
