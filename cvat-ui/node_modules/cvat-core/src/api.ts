...
function build(): CVATCore {
    const cvat: CVATCore = {
        ...
        customOperations: {
            async list(filter = {}) {
                const result = await PluginRegistry.apiWrapper(cvat.customOperations.list, filter);
                return result;
            },
            async get(id) {
                const result = await PluginRegistry.apiWrapper(cvat.customOperations.get, id);
                return result;
            },
            async create(data) {
                const result = await PluginRegistry.apiWrapper(cvat.customOperations.create, data);
                return result;
            },
            async update(id, data) {
                const result = await PluginRegistry.apiWrapper(cvat.customOperations.update, id, data);
                return result;
            },
            async delete(id) {
                const result = await PluginRegistry.apiWrapper(cvat.customOperations.delete, id);
                return result;
            },
            async execute(id, data) {
                const result = await PluginRegistry.apiWrapper(cvat.customOperations.execute, id, data);
                return result;
            },
        },
        logger,
    ...
    cvat.customOperations = Object.freeze(cvat.customOperations);
